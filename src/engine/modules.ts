...
export const MODULES: ModuleDefinition[] = [
  {
    ...
    description: "Escaneo de llaves de API, dependencias y flujos de datos expuestos",
    frameworks: ["owasp-llm", "gdpr", "col-1581"],
    basePayloads: 0,
    durationMs: 3200,
  },
  {
    ...
    description: "Simulación de jailbreaks contra el asistente en el sandbox",
    frameworks: ["owasp-llm", "col-1581", "col-1266", "gdpr"],
    basePayloads: 12,
    durationMs: 6400,
  },
  {
    ...
    frameworks: ["dark-patterns", "col-1581"],
    basePayloads: 4,
    durationMs: 3600,
  },
  {
